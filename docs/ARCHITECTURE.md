...
- [ ] **Fase 2 – Contenido estático**: Home (hero, franja de servicios, "Por qué DaeTrym", proceso, proyectos destacados, stack, FAQ, CTA, waitlist), Servicios (índice + 4 detalles con problema→solución→proceso→entregables→FAQ→CTA), Ciberseguridad (OWASP/NIST/PTES + aviso de autorización escrita), Nosotros, Proceso, Legal (3, con aviso), `/security` + `security.txt`, 404/500/mantenimiento.
